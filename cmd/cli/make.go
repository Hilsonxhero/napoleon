...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		upFile := nap.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := nap.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := nap.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "model":
		...
		fileName := nap.RootPath + "/data/" + strings.ToLower(modelName) + ".go"
